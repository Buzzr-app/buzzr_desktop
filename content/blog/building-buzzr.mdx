...
v1.5 lands this month with league-safe detail tables, 47 leagues parity, and a deeper game page (per-team leaders, soccer XI, F1 driver records, tennis tournaments, UFC fight cards). v1.6 is queued: web PWA out of beta, Android general availability, deeper crews, brackets, and roast reels.
