          ...
          <div key={item.q} className="border-t border-surface last:border-b">
            <dt>
              <button
                ...
                className="flex w-full items-center justify-between gap-6 py-5 text-left text-[16px] leading-[1.5] tracking-[-0.025em] text-foreground transition-colors hover:text-muted focus-visible:outline-none focus-visible:shadow-[0_0_0_2px_rgba(0,194,100,0.55)] rounded-sm"
              >
                <span>{item.q}</span>
                <span
                  aria-hidden
