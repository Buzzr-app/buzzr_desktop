...
const FAQS = [
  ...
  { q: 'What is Pollen?', a: 'In-app points. You start with 1,000 Pollen and earn 100 daily for checking in, with bonuses at 3, 7, 14, and 30-day streaks. Spend it on predictions, crew entries, and bracket entries. If you bankrupt below 50, you get auto-refilled to 250 once a day. No paywall, no purchases.' },
